...
index 3ea77b706ef563e7c33923f9ff8566cf68559527..0daf609ffaeedc6b0cc34da92c35ba8cf7a43c3c 100644
--- a/handlers/start.py
+++ b/handlers/start.py
@@ -1,189 +1,93 @@
- (cd "$(git rev-parse --show-toplevel)" && git apply --3way <<'EOF' 
-diff --git a/handlers/start.py b/handlers/start.py
-index 4165800f1548f86b47980997c9d2d9e8dffe8853..e7666c8b0354396fcc2de06b3e9ee6d5f60329d7 100644
---- a/handlers/start.py
-+++ b/handlers/start.py
-@@ -1,90 +1,90 @@
